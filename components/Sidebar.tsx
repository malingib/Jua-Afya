...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView }) => {
  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex-col w-64 bg-sidebar text-white fixed left-4 top-4 bottom-4 rounded-3xl z-20 shadow-2xl overflow-hidden">
        {/* Logo Area */}
      ...
      {/* Mobile Bottom Nav */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 z-30 px-6 py-3 flex justify-between items-center shadow-[0_-4px_20px_-1px_rgba(0,0,0,0.05)] safe-area-pb transition-colors">
