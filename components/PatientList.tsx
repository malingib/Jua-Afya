...
import { Search, Plus, Phone, FileText, Sparkles, X, Activity, MessageSquare, MoreHorizontal, Printer, Filter, Edit2, Save, User, Trash2 } from 'lucide-react';
      ...
      <div className="bg-white dark:bg-slate-800 w-full max-w-4xl max-h-[90vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-200">
        ...
        <div className="overflow-y-auto flex-1 p-6 md:p-8 space-y-8 bg-gray-50/50 dark:bg-slate-900/50">
            ...
            <div className="flex gap-4 overflow-x-auto pb-2">
                ...
                <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-200 rounded-xl font-medium text-sm hover:bg-slate-50 dark:hover:bg-slate-600 transition-colors whitespace-nowrap">
                ...
                <div className="bg-white dark:bg-slate-800 border border-brand-100 dark:border-slate-600 rounded-2xl p-4 shadow-xl animate-in slide-in-from-top-2">
                    ...
                    {!draftingSms && (
                        <div className="mt-3 flex justify-end gap-2">
                             <button className="text-xs font-semibold bg-brand-600 text-white px-4 py-2 rounded-lg hover:bg-brand-700 transition-colors">Send SMS</button>
                        </div>
                    )}
                </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2 space-y-4">
                     ...
                     <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm">
                        <h3 className="font-bold text-slate-900 dark:text-white mb-4">Visit History</h3>
